...
type UserApiClient interface {
	// unary
	AddUser(ctx context.Context, in *user.UserRequest, opts ...grpc.CallOption) (*user.UserResponse, error)
}
...
func (c *userApiClient) AddUser(ctx context.Context, in *user.UserRequest, opts ...grpc.CallOption) (*user.UserResponse, error) {
...
type UserApiServer interface {
	// unary
	AddUser(context.Context, *user.UserRequest) (*user.UserResponse, error)
...
func (UnimplementedUserApiServer) AddUser(context.Context, *user.UserRequest) (*user.UserResponse, error) {
...
func _UserApi_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserApiServer).AddUser(ctx, req.(*user.UserRequest))
	}
